...
public class LoginPagePom extends LoadableComponent<LoginPagePom> {
    ...
    @FindBy(how = How.CSS, using = "#page-36 > div > div.woocommerce > \" +\n" +
    ...
    @FindBy(how = How.CSS, using = "#page-36 > div > div.woocommerce > div > p:nth-child(1) > a")
...
//    }
    ...
    public String generateEmail() {
        ...
        result = "newuser" + random.nextInt() + "@gmail.com";
